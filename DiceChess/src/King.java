// This class constructs King objects and provides properties accordingly
public class King extends Piece{
  ...
  //Returns true if king object can move to (x,y) on the board, returns false otherwise
