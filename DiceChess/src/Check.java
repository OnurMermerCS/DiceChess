//This class checks several occasions according to the dice chess rule
public class Check
{
  //This method checks is there available peice according to result of the dice 
  ...
  //checks whether King is in danger or not
  ...
  //checks whether the piece is in danger or not
  public static boolean checkThreats(Player player, Board board, Piece piece)
  {
    ...
    if(y<8)
    {
      ...
      for(int i = y+1; i<=8 && flag; i++)
      {
        if(board.isTherePiece(x,i))
        {
          ...
          {
            if (board.getPiece(x,i) instanceof Rook || board.getPiece(x,i) instanceof Queen || (board.getPiece(x,i) instanceof King && i == y + 1))
            {
              return true;
            }
          }
    ...
    { 
      ...
      for(int i = x+1; i<=8 && flag; i++)
      {
        if(board.isTherePiece(i,y))
        {
          ...
          {
            if (board.getPiece(i,y) instanceof Rook || board.getPiece(i,y) instanceof Queen || (board.getPiece(i,y) instanceof King && i == x + 1))
            {
              return true;
            }
          }
    ...
    if(x<8 && y<8)
    {
      ...
      for(int i = x+1; i<=8 && flag; i++)
      {
        ...
        {
          if(i-x == j-y && board.isTherePiece(i,j))
          {
            ...
            else
            {
              ...
              if (i==x+1 && j==y+1 && board.getPiece(i,j) instanceof Pawn && board.getPiece(i,j).getPlayer().getColor().equals("Black"))
              {
                return true;
              }
    ...
    if(x>1 && y<8)
    {
      ...
      for(int i = x-1; i>0 && flag; i--)
      {
        for(int j = y+1; j<= 8 && flag; j++)
        {
          if(x-i == j-y && board.isTherePiece(i,j))
          {
            if (board.getPiece(i, j).getPlayer().getColor().equals(player.getColor()))
            {
              flag = false;
            ...
            else
            {
              ...
              if (i==x-1 && j==y+1 && board.getPiece(i,j) instanceof Pawn && board.getPiece(i,j).getPlayer().getColor().equals("White"))
              {
                return true;
              }
              if (board.getPiece(i,j) instanceof Bishop || board.getPiece(i,j) instanceof Queen)
    ...
    if(x>1 && y>1)
    {
      ...
      for(int i = x-1; i>0 && flag; i--)
      {
        ...
        {
          if(x-i == y-j && board.isTherePiece(i,j))
          {
            if (board.getPiece(i, j).getPlayer().getColor().equals(player.getColor()))
            {
              flag = false;
    ...
    if(x<8 && y>1)
    {
      ...
      for(int i = x+1; i<=8 && flag; i++)
      {
        for(int j = y-1; j> 8 && flag; j--)
        {
          if(i-x == y-j && board.isTherePiece(i,j))
          {
            if (board.getPiece(i, j).getPlayer().getColor().equals(player.getColor()))
            {
              flag = false;
  ...
  //checks whether the piece at (x,y) is in danger or not
  ...
  //returns array of pieces that threatens the given piece
