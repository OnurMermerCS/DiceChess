// This class constructs Bishop objects and provides properties accordingly
public class Bishop extends Piece {
  ...
  //Returns true if bishop object can move to (x,y) on the board, returns false otherwise
