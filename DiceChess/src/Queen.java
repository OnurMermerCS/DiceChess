// This class constructs Queen objects and provides properties accordingly
public class Queen extends Piece {
  ...
  //Returns true if queen object can move to (x,y) on the board, returns false otherwise
